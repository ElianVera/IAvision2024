...
public class MainActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Sección de los permisos de ejecución
        ...
        if (resultCode == RESULT_OK && null != data) {
            try {
                ...
                if (requestCode == REQUEST_CAMERA)
                    ...
                    mSelectedImage = MediaStore.Images.Media.getBitmap(getContentResolver(), data.getData()); mImageView.setImageBitmap(mSelectedImage);
